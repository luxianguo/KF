...
- The outer convergence is judged by MINUIT flag and $\epsilon<\varepsilon$, where $\varepsilon$ is chosen to accommodate the numerical accuracy. The choice of $\varepsilon$ will affect the convergence rate.
